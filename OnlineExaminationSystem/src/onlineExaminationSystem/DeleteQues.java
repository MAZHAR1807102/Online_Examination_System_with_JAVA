...
public class DeleteQues extends JFrame {
...
public DeleteQues()
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteQues frame = new DeleteQues();
	...
	public void DeleteQues1() {
					...
					btnAdd.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							try {
								...
								ps = con.prepareStatement("delete from test where ID = ?");
								ps.setString(1, QN);
								
								int k = ps.executeUpdate();
								if(k== 0)
								{
									JOptionPane.showMessageDialog(btnAdd, "This is already Deleted");
								}
								else
								{
									JOptionPane.showMessageDialog(btnAdd, "Qeustion Set is successfully DELETED");
									
									DeleteQues.this.dispose();
									DeleteQues qs = new DeleteQues();
									qs.setVisible(true);
								}
			...
			lblNewLabel.setBounds(0, 0, 852, 690);
